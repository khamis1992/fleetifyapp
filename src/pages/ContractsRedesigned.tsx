...
function ContractsRedesigned() {
  ...
  const ContractCard = ({ contract }: { contract: any }) => {
    const statusColors: Record<string, string> = {
      ...
      under_legal_procedure: "bg-amber-50 border-amber-200",
    };
    ...
    const cardBg = statusColors[contract.status] || "bg-white border-slate-200";
    ...
    return (
      <motion.div
        ...
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className={cn("rounded-2xl border p-5 hover:shadow-xl transition-all duration-300 cursor-pointer", cardBg)}
        onClick={() => handleViewDetails(contract)}
      >
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-start gap-4">
            <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0", iconGradient)}>
        ...
        <div className="border-t border-slate-200/50 pt-4 flex flex-wrap gap-2" onClick={(e) => e.stopPropagation()}>
          <Button variant="outline" size="sm" onClick={() => handleViewDetails(contract)} className="bg-slate-50 text-slate-700 hover:bg-slate-100 rounded-lg">
          ...
          <Button variant="outline" size="sm" onClick={() => {
            ...
            setShowContractWizard(true);
          }} className="bg-sky-50 text-sky-700 hover:bg-sky-100 rounded-lg">
            <Edit className="w-4 h-4 ml-2" />
            تعديل
          </Button>
          <Button variant="outline" size="sm" onClick={() => handleRenewContract(contract)} className="bg-violet-50 text-violet-700 hover:bg-violet-100 rounded-lg">
            <RefreshCw className="w-4 h-4 ml-2" />
            تجديد
          </Button>
          <Button variant="outline" size="sm" onClick={() => handleCancelContract(contract)} className="bg-rose-50 text-rose-700 hover:bg-rose-100 rounded-lg">
            <XCircle className="w-4 h-4 ml-2" />
            إلغاء
          </Button>
          <Button variant="outline" size="sm" className="bg-slate-50 text-slate-700 hover:bg-slate-100 rounded-lg ml-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Button
                  ...
                  className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-5 py-2.5 rounded-xl font-semibold shadow-lg shadow-red-200 transition-all"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="px-4 py-2.5 rounded-xl font-medium border-slate-200 hover:border-amber-400 hover:bg-amber-50 transition-all"
                >
                ...
                {user?.roles?.includes('super_admin') && (
                  <Button
                    ...
                    variant="outline"
                    className="px-4 py-2.5 rounded-xl font-medium border-slate-200 hover:border-sky-400 hover:bg-sky-50 transition-all"
                  >
                ...
                <Button
                  ...
                  variant="outline"
                  className="px-4 py-2.5 rounded-xl font-medium border-slate-200 hover:border-violet-400 hover:bg-violet-50 transition-all"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="px-4 py-2.5 rounded-xl font-medium border-slate-200 hover:border-emerald-400 hover:bg-emerald-50 transition-all"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="p-2.5 rounded-xl border-slate-200 hover:bg-slate-50 transition-all"
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {(contractDrafts.loadDrafts.data || []).map((draft) => (
                  <Card key={draft.id} className="hover:shadow-md transition-shadow border-slate-200">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pr-12 pl-12 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all outline-none"
                      value={searchInput}
                  ...
                  <Button
                    variant="outline"
                    className="px-4 py-2 rounded-lg font-medium hover:bg-slate-50 transition-colors"
                    onClick={() => {
                      setSearchInput("");
                      setActiveTab("all");
                    }}
                    ...
                    <div className="text-center py-16">
                      ...
                      {debouncedSearch ? (
                        ...
                        <>
                          ...
                          <Button onClick={() => setShowContractWizard(true)} className="bg-gradient-to-r from-red-500 to-red-600 text-white">
                            <Plus className="w-4 h-4 ml-2" />
                            إنشاء عقد جديد
                          </Button>
                        </>
