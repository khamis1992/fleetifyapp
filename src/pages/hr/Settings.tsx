      ...
      <div className="grid gap-6">
        ...
        <Card className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-3xl hover:border-teal-500/30 hover:shadow-xl hover:shadow-teal-500/10 transition-all">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-slate-900">إعدادات الحضور والانصراف</CardTitle>
            </div>
            <CardDescription className="text-slate-600">تكوين أوقات العمل وسياسات الحضور</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="working-hours" className="text-slate-700">ساعات العمل اليومية</Label>
                <Input
                  id="working-hours"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="working-days" className="text-slate-700">أيام العمل الأسبوعية</Label>
                <Input
                  id="working-days"
                  type="number"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="start-time" className="text-slate-700">وقت بداية العمل</Label>
                <Input
                  id="start-time"
                  type="time"
              ...
              <div className="space-y-2">
                <Label htmlFor="end-time" className="text-slate-700">وقت نهاية العمل</Label>
                <Input
                  id="end-time"
                  type="time"
            ...
            <div className="space-y-2">
              <Label htmlFor="late-threshold" className="text-slate-700">حد التأخير المسموح (بالدقائق)</Label>
              <Input
                id="late-threshold"
                type="number"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-slate-900">حساب الإضافي تلقائياً</Label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-slate-900">السماح بالأرصدة السالبة</Label>
                  <p className="text-sm text-slate-600">
        ...
        <Card className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-3xl hover:border-teal-500/30 hover:shadow-xl hover:shadow-teal-500/10 transition-all">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-slate-900">إعدادات الرواتب</CardTitle>
            </div>
            <CardDescription className="text-slate-600">تكوين حسابات الرواتب والخصومات</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="overtime-rate" className="text-slate-700">معدل الساعات الإضافية (%)</Label>
                <Input
                  id="overtime-rate"
                  type="number"
                  step="0.1"
                  ...
                  className="border-slate-200 focus:border-teal-500 focus:ring-teal-500"
                />
                <p className="text-xs text-slate-600">نسبة الزيادة على الساعة العادية للساعات الإضافية</p>
              </div>
              <div className="space-y-2">
                <Label htmlFor="late-penalty" className="text-slate-700">غرامة التأخير (للساعة)</Label>
                <Input
                  id="late-penalty"
                  type="number"
                  step="0.01"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="social-security" className="text-slate-700">نسبة التأمينات الاجتماعية (%)</Label>
                <Input
                  id="social-security"
                  type="number"
                  step="0.01"
              ...
              <div className="space-y-2">
                <Label htmlFor="tax-rate" className="text-slate-700">نسبة الضريبة (%)</Label>
                <Input
                  id="tax-rate"
                  type="number"
                  step="0.01"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="payroll-frequency" className="text-slate-700">دورية الرواتب</Label>
                <Select
              ...
              <div className="space-y-2">
                <Label htmlFor="pay-date" className="text-slate-700">يوم الدفع (من كل شهر)</Label>
                <Input
                  id="pay-date"
                  type="number"
                  min="1"
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <CardTitle className="text-slate-900">إعدادات الإجازات</CardTitle>
                  <CardDescription className="text-slate-600">إدارة أنواع الإجازات والأرصدة من جدول واحد موحد</CardDescription>
                </div>
              </div>
              <Dialog open={isLeaveTypeDialogOpen} onOpenChange={setIsLeaveTypeDialogOpen}>
                ...
                <DialogContent className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-3xl">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="leave-type-name" className="text-slate-700">اسم النوع (بالإنجليزية) *</Label>
                      <Input
                        id="leave-type-name"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="leave-type-name-ar" className="text-slate-700">اسم النوع (بالعربية) *</Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="max-days" className="text-slate-700">عدد الأيام المسموحة سنوياً</Label>
                      <Input
                        id="max-days"
                        type="number"
                    ...
                    <div className="flex items-center justify-between">
                      <Label className="text-slate-900">يتطلب موافقة المدير</Label>
                      <Switch
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="description" className="text-slate-700">الوصف</Label>
                      <Textarea
                        id="description"
                  ...
                  <DialogFooter>
                    <Button
                      ...
                      className="border-slate-200 hover:border-teal-500 hover:text-teal-600"
                    >
                      إلغاء
                    </Button>
                    <Button
            ...
            <div className="space-y-4">
              ...
              {leaveTypesLoading ? (
                ...
                <div className="space-y-3">
                  <h4 className="font-medium text-slate-900">أنواع الإجازات المتاحة</h4>
                        ...
                        <div key={leaveType.id} className="flex items-center justify-between p-3 border border-slate-200/50 rounded-xl hover:border-teal-500/30 hover:shadow-lg hover:shadow-teal-500/10 transition-all bg-white/50 backdrop-blur-sm">
                          <div className="flex-1">
                            ...
                            {leaveType.description && (
                              <p className="text-sm text-slate-600 mt-1">{leaveType.description}</p>
                            )}
                          </div>
                          <div className="flex items-center gap-2">
                            <Button
                            ...
                            <Button
                              ...
                              className="border-slate-200 hover:border-rose-500 hover:text-rose-600"
                            >
        ...
        <Card className="bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-3xl hover:border-teal-500/30 hover:shadow-xl hover:shadow-teal-500/10 transition-all">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-slate-900">موافقة المدير مطلوبة</Label>
                <p className="text-sm text-slate-600">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-slate-900">إشعارات البريد الإلكتروني</Label>
                <p className="text-sm text-slate-600">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-slate-900">إشعارات الرسائل النصية</Label>
                <p className="text-sm text-slate-600">
