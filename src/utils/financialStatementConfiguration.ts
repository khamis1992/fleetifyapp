...
export const noteDefinitions: { code: StatementNoteCode; ar: string; en: string; hintAr: string; hintEn: string }[] = [
  ...
  { code: 'noncash_transactions', ar: 'التدفقات والمعاملات غير النقدية', en: 'Cash flows and non-cash transactions', hintAr: 'مكونات النقد والسياسات والتسوية مع الميزانية العمومية والمعاملات الاستثمارية والتمويلية غير النقدية.', hintEn: 'Cash components, policies, reconciliation to financial position and non-cash investing/financing transactions.' },
