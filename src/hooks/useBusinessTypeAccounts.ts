...
// ===== LEVEL 6 - INDIVIDUAL CUSTOMER ACCOUNTS =====
      // Individual Cash Customers (30 accounts)
      ...
      { id: 'customer_layla_hassan', code: '112616', nameEn: 'Layla Hassan Al-Zayed', nameAr: 'ليلى حسن الزايد', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - ليلى حسن الزايد', isEntryLevel: true },
      { id: 'customer_omar_salim', code: '112617', nameEn: 'Omar Salim Al-Rashid', nameAr: 'عمر سالم الراشد', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - عمر سالم الراشد', isEntryLevel: true },
      { id: 'customer_maryam_abdulla', code: '112618', nameEn: 'Maryam Abdulla Al-Sabah', nameAr: 'مريم عبدالله الصباح', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - مريم عبدالله الصباح', isEntryLevel: true },
      { id: 'customer_hassan_ahmad', code: '112619', nameEn: 'Hassan Ahmad Al-Kuwaiti', nameAr: 'حسن أحمد الكويتي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - حسن أحمد الكويتي', isEntryLevel: true },
      { id: 'customer_nadia_youssef', code: '112620', nameEn: 'Nadia Youssef Al-Hajri', nameAr: 'نادية يوسف الهاجري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - نادية يوسف الهاجري', isEntryLevel: true },
      { id: 'customer_adel_mohammed', code: '112621', nameEn: 'Adel Mohammed Al-Dosari', nameAr: 'عادل محمد الدوسري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - عادل محمد الدوسري', isEntryLevel: true },
      { id: 'customer_amina_saleh', code: '112622', nameEn: 'Amina Saleh Al-Ansari', nameAr: 'أمينة صالح الأنصاري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - أمينة صالح الأنصاري', isEntryLevel: true },
      { id: 'customer_fahad_abdullah', code: '112623', nameEn: 'Fahad Abdullah Al-Thani', nameAr: 'فهد عبدالله الثاني', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - فهد عبدالله الثاني', isEntryLevel: true },
      { id: 'customer_reem_khalid', code: '112624', nameEn: 'Reem Khalid Al-Mazroui', nameAr: 'ريم خالد المزروعي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - ريم خالد المزروعي', isEntryLevel: true },
      { id: 'customer_saad_ali', code: '112625', nameEn: 'Saad Ali Al-Mansoori', nameAr: 'سعد علي المنصوري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - سعد علي المنصوري', isEntryLevel: true },
      { id: 'customer_dina_omar', code: '112626', nameEn: 'Dina Omar Al-Balushi', nameAr: 'دينا عمر البلوشي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - دينا عمر البلوشي', isEntryLevel: true },
      { id: 'customer_youssef_hassan', code: '112627', nameEn: 'Youssef Hassan Al-Nabulsi', nameAr: 'يوسف حسن النابلسي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - يوسف حسن النابلسي', isEntryLevel: true },
      { id: 'customer_rana_mohammed', code: '112628', nameEn: 'Rana Mohammed Al-Farsi', nameAr: 'رنا محمد الفارسي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - رنا محمد الفارسي', isEntryLevel: true },
      { id: 'customer_badr_abdulaziz', code: '112629', nameEn: 'Badr Abdulaziz Al-Ghanim', nameAr: 'بدر عبدالعزيز الغانم', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - بدر عبدالعزيز الغانم', isEntryLevel: true },
      { id: 'customer_lina_tariq', code: '112630', nameEn: 'Lina Tariq Al-Kandari', nameAr: 'لينا طارق الكندري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11261', essential: false, recommended: true, description: 'عميل فردي - لينا طارق الكندري', isEntryLevel: true },

      // Individual Credit Customers (25 accounts)
      { id: 'customer_nora_saad', code: '112631', nameEn: 'Nora Saad Al-Mansour', nameAr: 'نورا سعد المنصور', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - نورا سعد المنصور', isEntryLevel: true },
      { id: 'customer_abdullah_khalid', code: '112632', nameEn: 'Abdullah Khalid Al-Zahrani', nameAr: 'عبدالله خالد الزهراني', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - عبدالله خالد الزهراني', isEntryLevel: true },
      { id: 'customer_mona_abdulaziz', code: '112633', nameEn: 'Mona Abdulaziz Al-Qahtani', nameAr: 'منى عبدالعزيز القحطاني', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - منى عبدالعزيز القحطاني', isEntryLevel: true },
      { id: 'customer_tariq_mohammed', code: '112634', nameEn: 'Tariq Mohammed Al-Shammari', nameAr: 'طارق محمد الشمري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - طارق محمد الشمري', isEntryLevel: true },
      { id: 'customer_hind_ali', code: '112635', nameEn: 'Hind Ali Al-Otaibi', nameAr: 'هند علي العتيبي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - هند علي العتيبي', isEntryLevel: true },
      { id: 'customer_waleed_salim', code: '112636', nameEn: 'Waleed Salim Al-Awadi', nameAr: 'وليد سالم العوضي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - وليد سالم العوضي', isEntryLevel: true },
      { id: 'customer_yasmin_ahmad', code: '112637', nameEn: 'Yasmin Ahmad Al-Kharafi', nameAr: 'ياسمين أحمد الخرافي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - ياسمين أحمد الخرافي', isEntryLevel: true },
      { id: 'customer_majed_omar', code: '112638', nameEn: 'Majed Omar Al-Sulaiti', nameAr: 'ماجد عمر السليطي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - ماجد عمر السليطي', isEntryLevel: true },
      { id: 'customer_aisha_abdullah', code: '112639', nameEn: 'Aisha Abdullah Al-Rumaihi', nameAr: 'عائشة عبدالله الرميحي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - عائشة عبدالله الرميحي', isEntryLevel: true },
      { id: 'customer_faisal_khalid', code: '112640', nameEn: 'Faisal Khalid Al-Dosari', nameAr: 'فيصل خالد الدوسري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - فيصل خالد الدوسري', isEntryLevel: true },
      { id: 'customer_noura_hassan', code: '112641', nameEn: 'Noura Hassan Al-Maliki', nameAr: 'نورا حسن المالكي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - نورا حسن المالكي', isEntryLevel: true },
      { id: 'customer_salem_abdulaziz', code: '112642', nameEn: 'Salem Abdulaziz Al-Mutawa', nameAr: 'سالم عبدالعزيز المطوع', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - سالم عبدالعزيز المطوع', isEntryLevel: true },
      { id: 'customer_jameela_mohammed', code: '112643', nameEn: 'Jameela Mohammed Al-Bader', nameAr: 'جميلة محمد البدر', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - جميلة محمد البدر', isEntryLevel: true },
      { id: 'customer_abdullah_salim', code: '112644', nameEn: 'Abdullah Salim Al-Hajri', nameAr: 'عبدالله سالم الهاجري', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - عبدالله سالم الهاجري', isEntryLevel: true },
      { id: 'customer_lubna_youssef', code: '112645', nameEn: 'Lubna Youssef Al-Shatti', nameAr: 'لبنى يوسف الشطي', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11262', essential: false, recommended: true, description: 'عميل آجل - لبنى يوسف الشطي', isEntryLevel: true },

      // Private Companies (15 accounts)
      ...
      { id: 'company_al_faisal_construction', code: '112716', nameEn: 'Al-Faisal Construction', nameAr: 'شركة الفيصل للإنشاءات', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'شركة الفيصل للإنشاءات', isEntryLevel: true },
      { id: 'company_kuwait_industrial', code: '112717', nameEn: 'Kuwait Industrial Corp', nameAr: 'الشركة الكويتية الصناعية', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'الشركة الكويتية الصناعية', isEntryLevel: true },
      { id: 'company_al_bahar_marine', code: '112718', nameEn: 'Al-Bahar Marine Services', nameAr: 'شركة البحر للخدمات البحرية', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'شركة البحر للخدمات البحرية', isEntryLevel: true },
      { id: 'company_al_watan_hotels', code: '112719', nameEn: 'Al-Watan Hotels Group', nameAr: 'مجموعة الوطن للفنادق', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'مجموعة الوطن للفنادق', isEntryLevel: true },
      { id: 'company_gulf_petroleum', code: '112720', nameEn: 'Gulf Petroleum Services', nameAr: 'شركة الخليج للخدمات البترولية', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'شركة الخليج للخدمات البترولية', isEntryLevel: true },
      { id: 'company_al_salem_tech', code: '112721', nameEn: 'Al-Salem Technology', nameAr: 'شركة السالم للتكنولوجيا', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'شركة السالم للتكنولوجيا', isEntryLevel: true },
      { id: 'company_emirates_trading', code: '112722', nameEn: 'Emirates Trading LLC', nameAr: 'شركة الإمارات للتجارة', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'شركة الإمارات للتجارة', isEntryLevel: true },
      { id: 'company_al_majed_group', code: '112723', nameEn: 'Al-Majed Business Group', nameAr: 'مجموعة الماجد التجارية', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'مجموعة الماجد التجارية', isEntryLevel: true },
      { id: 'company_national_projects', code: '112724', nameEn: 'National Projects Company', nameAr: 'شركة المشاريع الوطنية', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'شركة المشاريع الوطنية', isEntryLevel: true },
      { id: 'company_al_khaleej_finance', code: '112725', nameEn: 'Al-Khaleej Finance House', nameAr: 'بيت الخليج للتمويل', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11271', essential: false, recommended: true, description: 'بيت الخليج للتمويل', isEntryLevel: true },

      // ===== LEVEL 6 - INDIVIDUAL VEHICLE ACCOUNTS =====
      // Sedan Fleet (15 vehicles)
      ...
      { id: 'vehicle_accord_mno345', code: '115116', nameEn: 'Honda Accord 2023 - MNO345', nameAr: 'هوندا أكورد 2023 - لوحة MNO345', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'هوندا أكورد 2023 - لوحة MNO345', isEntryLevel: true },
      { id: 'vehicle_sentra_pqr678', code: '115117', nameEn: 'Nissan Sentra 2024 - PQR678', nameAr: 'نيسان سنترا 2024 - لوحة PQR678', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'نيسان سنترا 2024 - لوحة PQR678', isEntryLevel: true },
      { id: 'vehicle_civic_stu901', code: '115118', nameEn: 'Honda Civic 2023 - STU901', nameAr: 'هوندا سيفيك 2023 - لوحة STU901', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'هوندا سيفيك 2023 - لوحة STU901', isEntryLevel: true },
      { id: 'vehicle_maxima_vwx234', code: '115119', nameEn: 'Nissan Maxima 2022 - VWX234', nameAr: 'نيسان ماكسيما 2022 - لوحة VWX234', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'نيسان ماكسيما 2022 - لوحة VWX234', isEntryLevel: true },
      { id: 'vehicle_jetta_yza567', code: '115120', nameEn: 'Volkswagen Jetta 2023 - YZA567', nameAr: 'فولكس واجن جيتا 2023 - لوحة YZA567', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'فولكس واجن جيتا 2023 - لوحة YZA567', isEntryLevel: true },
      { id: 'vehicle_cerato_bcd890', code: '115121', nameEn: 'Kia Cerato 2024 - BCD890', nameAr: 'كيا سيراتو 2024 - لوحة BCD890', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'كيا سيراتو 2024 - لوحة BCD890', isEntryLevel: true },
      { id: 'vehicle_optima_efg123', code: '115122', nameEn: 'Kia Optima 2023 - EFG123', nameAr: 'كيا أوبتيما 2023 - لوحة EFG123', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'كيا أوبتيما 2023 - لوحة EFG123', isEntryLevel: true },
      { id: 'vehicle_passat_hij456', code: '115123', nameEn: 'Volkswagen Passat 2022 - HIJ456', nameAr: 'فولكس واجن باسات 2022 - لوحة HIJ456', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'فولكس واجن باسات 2022 - لوحة HIJ456', isEntryLevel: true },
      { id: 'vehicle_avalon_klm789', code: '115124', nameEn: 'Toyota Avalon 2023 - KLM789', nameAr: 'تويوتا أفالون 2023 - لوحة KLM789', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'تويوتا أفالون 2023 - لوحة KLM789', isEntryLevel: true },
      { id: 'vehicle_legacy_nop012', code: '115125', nameEn: 'Subaru Legacy 2024 - NOP012', nameAr: 'سوبارو ليجاسي 2024 - لوحة NOP012', accountType: 'assets', accountLevel: 6, balanceType: 'debit', parentCode: '11511', essential: false, recommended: true, description: 'سوبارو ليجاسي 2024 - لوحة NOP012', isEntryLevel: true },
...
export const useBusinessTypeAccounts = () => {
  ...
  const getCarRentalFullTemplate = (): AccountTemplate[] => {
    const carRentalBusinessAccounts = getAccountsByBusinessType('car_rental');
    return [
      ...carRentalBusinessAccounts.assets,
      ...carRentalBusinessAccounts.liabilities,
      ...carRentalBusinessAccounts.revenue,
      ...carRentalBusinessAccounts.expenses,
      ...carRentalBusinessAccounts.equity
    ];
  };

  return {
    getAccountsByBusinessType,
    getCarRentalFullTemplate,
    generateAccountCode,
