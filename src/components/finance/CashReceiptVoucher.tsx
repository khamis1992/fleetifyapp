...
export const CashReceiptVoucher: React.FC<CashReceiptVoucherProps> = ({
  ...
  return (
    <Card className={"w-full max-w-4xl mx-auto bg-white shadow-lg border-2 border-slate-800 " + (className || "")}>
      {/* Header Section */}
        ...
        <div className="space-y-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
            ...
            <Input
              ...
              className="md:col-span-3 w-full border-b border-slate-400 p-1 text-lg font-bold text-[#004d40] focus:border-[#004d40] focus:ring-0 bg-white"
              readOnly
            />
          </div>
