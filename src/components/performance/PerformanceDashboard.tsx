        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-slate-50 p-4 rounded-lg">
              ...
              <div className="text-sm text-slate-600">Average Execution Time</div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="px-4 py-2 text-left font-medium text-slate-700">Query Key</th>
                    <th className="px-4 py-2 text-center font-medium text-slate-700">Executions</th>
                    <th className="px-4 py-2 text-center font-medium text-slate-700">Avg Time</th>
                    <th className="px-4 py-2 text-center font-medium text-slate-700">Min/Max</th>
                    <th className="px-4 py-2 text-center font-medium text-slate-700">Cache Rate</th>
                    <th className="px-4 py-2 text-center font-medium text-slate-700">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {metricsArray.map((metric, index) => (
                    <tr key={metric.queryKey.join('.')} className={index % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
