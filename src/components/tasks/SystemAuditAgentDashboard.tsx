...
const commandLabels: Record<string, string> = {
  ...
  "excel_import.create_payment": "إنشاء دفعة جديدة من Excel",
  "excel_import.increase_payment": "إضافة فرق على دفعة Excel",
  "excel_import.reverse_payment": "عكس أو تخفيض دفعة Excel",
  "excel_import.create_late_fee": "إنشاء غرامة تأخير من Excel",
  "excel_import.adjust_late_fee": "تعديل غرامة تأخير من Excel",
  "excel_import.create_traffic_violation": "إنشاء مخالفة مرورية من Excel",
  "excel_import.adjust_traffic_violation": "تعديل مخالفة مرورية من Excel",
  "excel_import.create_maintenance": "إنشاء سجل صيانة من Excel",
  "excel_import.adjust_maintenance": "تعديل سجل صيانة من Excel",
  "excel_import.classify_text": "تصنيف نص غير منظم في Excel",
  "excel_import.no_change": "التحقق من صف Excel دون تغيير",
...
const reviewLabels: Record<string, string> = {
  ...
  "excel_import.increase_payment": "زيادة مبلغ دفعة مستوردة",
  "excel_import.reverse_payment": "تخفيض أو حذف دفعة مستوردة",
  "excel_import.create_late_fee": "غرامة تأخير مستوردة",
  "excel_import.adjust_late_fee": "تعديل غرامة تأخير مستوردة",
  "excel_import.create_traffic_violation": "مخالفة مرورية مستوردة",
  "excel_import.adjust_traffic_violation": "تعديل مخالفة مرورية مستوردة",
  "excel_import.create_maintenance": "صيانة تاريخية مستوردة",
  "excel_import.adjust_maintenance": "تعديل صيانة تاريخية",
  "excel_import.no_change": "صف مستورد مطابق دون تغيير",
