  ...
  if (variant === 'compact') {
    return (
      <button
        ...
        className={`
          flex items-center space-x-2 px-3 py-2 text-sm font-medium text-slate-700
          bg-white border border-slate-300 rounded-md shadow-sm
          hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        disabled={disabled || isChanging}
        className={`
          flex items-center space-x-2 px-4 py-2 text-sm font-medium text-slate-700
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className={`
            absolute z-50 w-64 bg-white border border-slate-200 rounded-lg shadow-lg
            ${getPositionClasses()}
          `}>
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      transition-colors duration-200
                      ${lang.isCurrent ? 'bg-blue-50 text-blue-700' : 'text-slate-700'}
                      ${disabled || isChanging ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}
                    `}
                    dir={textDir}
                  >
