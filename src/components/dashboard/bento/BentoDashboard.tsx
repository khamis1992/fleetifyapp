...
export default BentoDashboard;
        <motion.div
          ...
          className="col-span-4 bg-white rounded-2xl p-5 shadow-sm"
        >
          <h3 className="font-bold text-neutral-900 text-sm mb-4">إجراءات سريعة</h3>
          <div className="grid grid-cols-2 gap-2">
            <button
              onClick={() => navigate('/fleet/contracts/new')}
              className="flex flex-col items-center gap-2 p-3 bg-coral-50 rounded-xl hover:bg-coral-100 transition-colors"
            >
              <div className="w-10 h-10 bg-coral-500 rounded-lg flex items-center justify-center">
                <Plus className="w-5 h-5 text-white" />
              </div>
              <span className="text-xs font-medium text-neutral-700">عقد جديد</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-xs font-medium text-neutral-700">عميل جديد</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-xs font-medium text-neutral-700">مركبة جديدة</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-xs font-medium text-neutral-700">فاتورة جديدة</span>
            </button>
          </div>
        </motion.div>
      </div>
