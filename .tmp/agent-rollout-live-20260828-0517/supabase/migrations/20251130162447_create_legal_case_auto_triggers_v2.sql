...
-- RLS Policies for legal_case_auto_triggers (using profiles table)
CREATE POLICY "legal_case_auto_triggers_select_policy"
...
CREATE POLICY "legal_case_auto_triggers_insert_policy"
...
CREATE POLICY "legal_case_auto_triggers_update_policy"
...
-- RLS Policies for payment_promises (using profiles table)
CREATE POLICY "payment_promises_select_policy"
...
CREATE POLICY "payment_promises_insert_policy"
...
CREATE POLICY "payment_promises_update_policy"
...
DROP TRIGGER IF EXISTS update_legal_case_auto_triggers_updated_at ON legal_case_auto_triggers;
CREATE TRIGGER update_legal_case_auto_triggers_updated_at
  BEFORE UPDATE ON legal_case_auto_triggers
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_payment_promises_updated_at ON payment_promises;
