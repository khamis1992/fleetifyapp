...
DROP POLICY IF EXISTS "Users can view tags for their company" ON contract_tags;
...
DROP POLICY IF EXISTS "Users can manage tags for their company" ON contract_tags;
...
DROP POLICY IF EXISTS "Users can view tag assignments" ON contract_tag_assignments;
...
DROP POLICY IF EXISTS "Users can manage tag assignments" ON contract_tag_assignments;
...
DROP TRIGGER IF EXISTS trigger_auto_tag_contract ON contracts;
