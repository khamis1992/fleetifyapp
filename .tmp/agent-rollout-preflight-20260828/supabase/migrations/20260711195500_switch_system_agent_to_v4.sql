-- Point the validated schedule at the final versioned Edge Functions.
...
AS $$
  SELECT net.http_post(
    url := 'https://qwhunliohlkkahbspfiu.supabase.co/functions/v1/system-audit-orchestrator-v4',
