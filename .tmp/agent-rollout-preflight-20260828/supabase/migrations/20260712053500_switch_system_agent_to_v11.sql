-- Move scheduled dispatch to fresh edge-function aliases so no stale instance can receive work.
...
AS $$
  SELECT net.http_post(
    url := 'https://qwhunliohlkkahbspfiu.functions.supabase.co/system-audit-orchestrator-v11',
