-- Calculate actual balance from payments instead of trusting balance_due field
...
BEGIN
    ...
    IF NEW.invoice_id IS NOT NULL THEN
        ...
        IF FOUND THEN
            IF v_invoice.payment_status IN ('cancelled', 'voided', 'paid') THEN
                RAISE EXCEPTION USING
                    ERRCODE = '23514',
                    MESSAGE = 'Cannot add payment to this invoice',
                    HINT = 'Invoice status is: ' || v_invoice.payment_status;
            END IF;
