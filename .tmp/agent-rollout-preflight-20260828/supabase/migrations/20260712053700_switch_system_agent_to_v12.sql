-- Point daily and resume dispatch to the isolated schedule-graph release.
...
AS $$
  SELECT net.http_post(
    url := 'https://qwhunliohlkkahbspfiu.functions.supabase.co/system-audit-orchestrator-v12',
