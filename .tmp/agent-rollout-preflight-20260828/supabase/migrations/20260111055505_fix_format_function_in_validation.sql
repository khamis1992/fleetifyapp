                ...
                ELSE
                    IF NEW.amount > v_invoice.balance_due THEN
                        RAISE EXCEPTION USING
                            ...
                            HINT = 'Payment amount (QAR ' || TO_CHAR(NEW.amount, 'FM999,999,999.00') ||
                                   ') exceeds remaining invoice balance (QAR ' || TO_CHAR(v_invoice.balance_due, 'FM999,999,999.00') ||
                                   '). Invoice total: QAR ' || TO_CHAR(v_invoice.total_amount, 'FM999,999,999.00') ||
                                   ', Already paid: QAR ' || TO_CHAR(v_invoice.total_amount - v_invoice.balance_due, 'FM999,999,999.00') ||
