...
-- Fix the generate_invoices_from_payment_schedule function to use public schema explicitly
CREATE OR REPLACE FUNCTION public.generate_invoices_from_payment_schedule(p_contract_id UUID)
RETURNS INTEGER
LANGUAGE plpgsql
SECURITY DEFINER
