...
BEGIN
  ...
  --    reversed and reposted correctly. Invoices with payment history receive
  --    a discount (credit) journal for the delta and are aligned to the
  --    written amount; the customer payment is never rewritten.
  FOR v_invoice IN
    SELECT invoice.*
