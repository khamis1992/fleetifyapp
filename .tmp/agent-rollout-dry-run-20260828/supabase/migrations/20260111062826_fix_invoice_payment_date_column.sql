-- Fix check_and_calculate_late_fee_on_payment function to remove non-existent payment_date column from invoices
...
BEGIN
    ...
    -- Get active late fee rule for this company (use is_enabled instead of is_active)
    SELECT * INTO v_rule
    FROM late_fee_rules
