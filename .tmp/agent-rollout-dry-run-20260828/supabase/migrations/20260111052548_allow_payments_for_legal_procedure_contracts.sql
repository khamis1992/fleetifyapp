-- ================================================================
-- Migration: Allow Payments for Contracts Under Legal Procedure
-- Created: 2026-01-27
-- Description: Update payment validation to allow payments for contracts with 'under_legal_procedure' status
-- Impact: MEDIUM - Allows payments for contracts undergoing legal procedures
-- ================================================================
...
BEGIN
    ...
    IF NEW.contract_id IS NOT NULL THEN
        ...
        IF FOUND THEN
            ...
            -- Added 'under_legal_procedure' to allow payments for contracts undergoing legal procedures
...
Updated: Now allows payments for contracts with "under_legal_procedure" status.';;
