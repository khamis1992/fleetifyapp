-- Point scheduled execution to the database-tolerance-aligned final functions.
...
AS $$
  SELECT net.http_post(
    url := 'https://qwhunliohlkkahbspfiu.supabase.co/functions/v1/system-audit-orchestrator-v7',
