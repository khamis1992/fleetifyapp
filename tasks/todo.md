...
## توحيد عرض أسماء العملاء ✅

### المشكلة
الأسماء في صفحة Employee Workspace لا تطابق الأسماء في صفحة تفاصيل العميل.

### الحل
استخدام دالة `formatCustomerName()` الموحدة في جميع الأماكن:

#### الملفات المحدّثة:
1. ✅ `src/hooks/useMonthlyCollections.ts` - قائمة التحصيل الشهري
2. ✅ `src/hooks/useEmployeeContracts.tsx` - قائمة العقود والأولويات
3. ✅ `src/pages/EmployeeWorkspace.tsx` - عرض العقود

#### قواعد التسمية الموحدة:
- **للشركات**: `company_name_ar` أولاً، ثم `company_name`
- **للأفراد**: `first_name + last_name` أولاً، ثم `first_name_ar + last_name_ar`
- **Fallback**: `full_name` أو "غير محدد"

### النتيجة:
✅ الأسماء الآن **متطابقة** في جميع الصفحات!
