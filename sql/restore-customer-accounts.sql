-- Complete Customer Account Linking Fix
-- This script creates the auto_create_customer_accounts function and sets up default company settings
...
-- Create utility function to fix existing customers without accounts
...
-- Set default customer account settings for all existing companies
UPDATE companies 
