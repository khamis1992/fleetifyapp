-- Rollback of 20260921120100_balance_sheet_governance.sql
-- Restores the pre-governance period() and approve_report() definitions from
-- 20260917235302_professional_balance_sheets.sql / 20260917235336_financial_statement_packages.sql.
BEGIN;
...
DROP TABLE IF EXISTS public.balance_sheet_negative_explanations;
