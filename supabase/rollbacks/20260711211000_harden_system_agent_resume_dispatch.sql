-- Restore the v8 daily target and the preceding hourly recovery schedule.
...
DROP FUNCTION IF EXISTS public.invoke_system_audit_orchestrator_resume_v1();
...
AS $$
  SELECT net.http_post(
    url := 'https://qwhunliohlkkahbspfiu.supabase.co/functions/v1/system-audit-orchestrator-v8',
