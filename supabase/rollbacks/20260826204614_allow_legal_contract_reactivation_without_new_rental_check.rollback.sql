-- Restores penalty eligibility enforcement for every active-contract transition.
-- The transaction-local marker written by cancel_legal_cases_v1 becomes inert.
