...
BEGIN
 FOR r IN SELECT * FROM public.financial_data_repair_snapshots WHERE company_id='24bc0b21-4e2d-4413-9842-31719a3669f4' AND migration_version='20260906185414' AND rolled_back_at IS NULL FOR UPDATE LOOP
