-- إصلاح المشاكل الأمنية في الوظائف
-- إضافة SET search_path TO '' للوظائف الجديدة

-- تحديث وظيفة توليد رقم الدفع
...
-- تحديث وظيفة إنشاء القيد المحاسبي
...
-- تحديث وظيفة معالجة تغييرات الدفع
