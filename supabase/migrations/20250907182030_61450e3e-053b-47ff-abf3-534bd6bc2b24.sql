...
DROP POLICY IF EXISTS "Users can view csv-archives files" ON storage.objects;
DROP POLICY IF EXISTS "Users can upload csv-archives files" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete their csv-archives files" ON storage.objects;
DROP POLICY IF EXISTS "Admins can upload template files to csv-archives root" ON storage.objects;
