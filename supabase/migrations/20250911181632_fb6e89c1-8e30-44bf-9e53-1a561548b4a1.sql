-- إصلاح مشكلة الحسابات المكررة - حذف جميع الحسابات وإعادة إنشائها
...
BEGIN
    ...
    IF noor_company_id IS NOT NULL THEN
        -- حذف جميع الحسابات للشركة (بما في ذلك النظام)
        ...
        RAISE NOTICE 'تم حذف وإعادة إنشاء دليل الحسابات لشركة النور بنجاح - تم إنشاء % حساب', 
