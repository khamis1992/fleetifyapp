-- Fix the statistics function to use correct column relationship
...
BEGIN
    ...
    INNER JOIN (
        ...
        AND p2.invoice_id IS NULL  -- Fixed: Check for NULL invoice_id in payments table
    ...
    AND p.invoice_id IS NULL;  -- Fixed: Check for NULL invoice_id in payments table
...
-- Fix the backfill function to use correct column relationship
