...
CREATE TABLE IF NOT EXISTS public.approval_workflows (
    ...
    CONSTRAINT unique_workflow_name_per_company UNIQUE (company_id, workflow_name)
);
...
CREATE TABLE IF NOT EXISTS public.approval_requests (
    ...
    CONSTRAINT unique_request_number_per_company UNIQUE (company_id, request_number)
);
