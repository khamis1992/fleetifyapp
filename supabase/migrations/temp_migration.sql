...
BEGIN
  ...
  INSERT INTO temp_contract_data VALUES
    ...
    ('AGR-202504-408522', '2767', 'Ø¹Ø¨Ø¯ Ø§Ù„ØºÙÙˆØ± Ø¯Ø±Ø§Ø±', '97477122519'),
    ...
    ('AGR-202504-399591', '2782', 'Ø´Ø±ÙÙŠ Ø¹Ø¨Ø¯ Ø§Ù„Ù„Ù‡', '97477517797'),
    ...
    ('AGR-202504-421999', '10853', 'Ø¹Ø¨Ø¯ Ø§Ù„Ø­Ù…ÙŠØ¯ Ø¹ØªØ±ÙˆÙ†', '97450643428'),
    ...
    ('AGR-202504-414082', '10851', 'Ø§Ø³Ù„Ø§Ù… Ø¹Ø«Ù…Ø§Ù† Ù…Ø­Ù…Ø¯ÙŠÙ†', '97455025546'),
    ...
    ('AGR-202504-406129', '856718', 'Ø­Ø³Ø§Ù† Ø¨Ùˆ Ø¹Ù„Ø§Ù‚', '66553638'),
    ...
    ('AGR-202504-417240', '10671', 'ÙŠØ§Ø³Ø± Ø§Ù„ØµØ§Ø¯Ù‚ Ø§Ù„Ù‚Ø§Ø³Ù…', '97455990635'),
    ('AGR-202502-0418', '10174', 'ÙƒØ¨ÙŠØ±ÙˆÙ… Ø§Ù„Ø¹Ø±Ø¬Ø§ÙˆÙŠ ÙˆÙ„Ø¯ÙƒÙŠØ¯Ø§Ù†', '30796407'),
    ...
    ('AGR-202504-409871', '7054', 'Ù…Ø­Ù…Ø¯ Ø¬Ø§Ø³Ù… ØµØ§Ù„Ø­', '97466684460'),
    ...
    ('AGR-202504-417839', '7042', 'Ø¥Ø¨Ø±Ø§Ù‡ÙŠÙ… ÙŠØ¹Ù‚ÙˆØ¨', '97430882244'),
    ('AGR-202504-420819', '8208', 'Ø¹ØµØ§Ù… Ø§Ø­Ù…Ø¯Ø§Ø­Ù…Ø¯', '97466276263'),
    ...
    ('AGR-202504-398252', '21860', 'Ù…Ø­Ù…Ø¯ Ø§Ù„Ø¹ÙˆÙŠÙ†ÙŠ', '668168169'),
    ...
    ('AGR-202504-407328', '7034', 'Ø¹Ù…Ø§Ø± Ø§Ù„Ø´ÙŠØ®', '97433386066'),
    ...
    ('AGR-202504-412862', '185573', 'Ø¥ÙŠÙ‡Ø§Ø¨ Ø¹Ø¨Ø¯ Ø§Ù„Ù„Ù‡', '97431009664'),
    ('LTO2024291', '381247', 'abdulla al-shahri', '97433933920'),
    ('AGR-202504-419022', '856589', 'ÙŠØ­ÙŠÙ‰ Ø¹Ø¨Ø¯ Ø§Ù„Ø±Ø­Ù…Ø§Ù†', '97430757943'),
    ('LTO2024151', '2783', 'chrisus arinaitwe', '97474459955'),
    ('AGR-202504-416046', '8209', 'Ù‡Ø´Ø§Ù… Ø¹Ø¨Ø¯ Ø§Ù„Ø¹Ø¸ÙŠÙ…', '97431009664'),
    ...
    ('AGR-635810-055', '9902', 'Ø²ÙŠÙ† Ø§Ù„Ø¹Ø§Ø¨Ø¯ÙŠÙ† Ø§Ø¯Ø±ÙŠØ³', '97470897519'),
    ...
    ('AGR-202504-424367', '7040', 'Ù…Ø­Ù…Ø¯ Ø¥Ø¨Ø±Ø§Ù‡ÙŠÙ…', '97450506797'),
    ...
    ('AGR-954526-295', '2776', 'Ø³ÙŠÙ Ø§Ù„Ø¯ÙˆÙ„Ø© Ø¹ÙŠØ³Ù‰', '97474033341'),
    ('Ret-2018129', '721440', 'mohamed shikh', '97470075026'),
    ('AGR-202502-0416', '2778', 'ÙŠÙˆØ³Ù Ø³Ù‚Ø§Ù…', '33721869'),
    ...
    ('AGR-202504-414676', '856878', 'Ù…Ø¤Ù…Ù† Ø¹Ù„ÙŠ Ø³Ø¹ÙŠØ¯', '97474024205'),
    ...
    ('AGR-055405-212', '7063', 'Ù…Ù‡Ù†Ø¯ Ø­Ù…ÙˆØ¯ Ø§Ù„Ø¸Ø§Ù‡Ø±', '97430623322'),
    ...
    ('AGR-202504-403859', '2779', 'Ù…Ø®ØªØ§Ø± Ø¹Ù„ÙŠÙ„', '97477227716'),
    ...
    ('AGR-463481-549', '4014', 'Ù…Ø­Ù…Ø¯ Ø¹Ù„ÙŠ Ø³Ù„ÙŠÙ…', '97430797703'),
    ('LTO2024138', '7040', 'RAFIK BELKACEM', '31215469'),
    ('LTO202455', '10856', 'AYMEN NASRA', '97450171785'),
    ('AGR-202504-418432', '5891', 'Ù…ÙˆØ³Ù‰ Ø­ÙŠÙ…Ø±', '97471503673'),
    ...
    ('AGR-202504-411671', '5894', 'Ø¹Ø¨Ø¯ Ø§Ù„Ù„Ù„Ù‡ Ø§Ù„Ø¹Ù„ÙˆØ§Ù†ÙŠ', '97470897519'),
    ...
    ('AGR-202504-403263', '21849', 'ÙØ§Ø¯ÙŠ Ø§Ù„Ø³Ø¹ÙŠØ¯ÙŠ', '97466043445'),
    ...
    ('AGR-202504-410464', '2774', 'Ù‡Ø§Ù†ÙŠ Ø¨Ø±Ø§Ù‡Ù…ÙŠ', '97466521616'),
    ...
    ('AGR-202502-0422', '2767', 'Ø¹Ø¨Ø¯Ø§Ù„ØºÙÙˆØ± Ø¯Ø±Ø§Ø±', '77122519'),
    ...
    ('AGR-202504-397268', '2778', 'ÙŠÙˆØ³Ù Ø³Ù‚Ø§Ù…', '33721869'),
    ('AGR-202504-400949', '10668', 'Ø¹Ø¨Ø¯ Ø§Ù„Ù…Ù†Ø¹Ù…', '97470184904'),
    ...
    ('AGR-202504-405141', '8212', 'Ø­Ø³Ù† Ù…Ø­Ù…Ø¯ Ø§Ù„ÙÙƒÙŠ', '97450055884'),
    ...
    ('AGR-202504-413489', '7056', 'Ø¹Ù„Ù… Ø§Ù„Ø¯ÙŠÙ† Ø¬Ù…Ø¹Ø©', '97466188278'),
    ...
    ('AGR-202504-416649', '8213', 'Ù…ØµØ·ÙÙ‰  Ø³Ø§ØªÙŠ', '97471826567'),
    ...
    ('AGR-283909-351', '756104', 'ÙŠØ­ÙŠÙ‰ Ø§Ø­Ù…Ø¯ Ø¹Ø¨Ø¯Ø§Ù„Ø±Ø­Ù…Ù†', '97430757943'),
    ...
    ('AGR-202502-0430', '856718', 'Ø­Ø³Ø§Ù† Ø¨Ùˆ Ø¹Ù„Ø§Ù‚', '66553638'),
    ...
    ('AGR-202504-411066', '2768', 'Ø¹Ø¨Ø¯ Ø§Ù„Ø¹Ø²ÙŠØ² Ø¹Ù„ÙŠ', '97470342655'),
    ('LTO2024332', '2778', 'ABDELAZIZ JERFEL', '97433767961'),
    ('139', '5893', 'omar hmem', '97459993757'),
    ('AGR-202504-407921', '2773', 'ÙŠÙˆØ³Ù Ù‚Ø§Ø¨Ù„', '97471155135'),
    ('AGR-202502-0420', '7038', 'Ø«Ø§Ù…Ø± Ù…Ø­Ù…Ø¯ ', '30067536'),
    ...
    ('AGR-202504-406726', '5896', 'Ù…Ø®ØªØ§Ø±Ø§Ù„Ø§Ù…ÙŠÙ†', '97450129848'),
    ...
    ('AGR-047661-681', '2773', 'Ù…Ø¬Ø¯ÙŠ Ø¨Ø®ÙŠØª', '97450246458'),
    ('AGR-202504-420218', '4016', 'Ø³Ø§Ù…ÙŠ Ø¹Ø¨Ø¯ Ø§Ù„Ù„Ù‡', '97430534902'),
    ...
    ('AGR-222397-636', '862165', 'Ù…Ø­Ù…Ø¯ Ø¹Ø¨Ø¯ Ø§Ù„Ù„Ù‡ Ø³Ù„Ù…Ø§Ù†', '97455554627'),
    ...
    ('AGR-592533-558', '7041', 'Ø§Ø­Ù…Ø¯ Ø¹Ø¨Ø¯Ø§Ù„Ù„Ù‡ Ù…Ø­Ù…Ø¯', '97470692014'),
    ('LTO202415', '8214', 'Zyed Yahmadi', '97430330103'),
    ('MR202477', '749403', 'shadrack saky', '97455076981'),
    ('AGR-202504-402280', '856715', 'ÙØ§Ø¯ÙŠ Ø§Ù„Ø³Ø¹ÙŠØ¯ÙŠ', '97466043445'),
    ('LTO202494', '10197', 'KOSAY HAMMAMI', '97477860733'),
    ('AGR-202504-424958', '2766', 'Ù…Ø­Ù…Ø¯ Ù…Ø­Ù…Ø¯ Ø§Ø­Ù…Ø¯', '97470007983'),
    ...
    ('AGR-202502-0426', '21860', 'Ù…Ø­Ù…Ø¯ Ø§Ù„Ø¹ÙˆÙŠÙ†ÙŠ', '668168169'),
    ...
    ('AGR-202504-423180', '7039', 'Ø¹Ø¨Ø¯ Ø§Ù„Ù„Ù‡ Ø¨Ø±Ù‡Ø§Ù…', '97430945601'),
    ('AGR-202504-422586', '10858', 'Ù‚Ø³ÙˆØ±Ø© Ø¹Ø¨Ø¯ Ø§Ù„Ø±Ø­ÙŠÙ…', '97471109995'),
    ...
    ('AGR-202502-0424', '5891', 'Ù…Ø¤Ø³Ù‰ Ø­ÙŠÙ…Ø±', '71503673'),
    ...
    ('AGR-202504-421408', '2771', 'Ù…Ø§Ù‡Ø± Ù…Ù‡ÙŠØ±ÙŠ', '97470220390'),
    ...
    ('AGR-950558-871', '9902', 'Ø²ÙŠÙ† Ø§Ù„Ø¹Ø§Ø¨Ø¯ÙŠÙ† Ø§Ø¯Ø±ÙŠØ³', '97470897519'),
    ...
    ('AGR-302522-016', '7057', 'Ø¨Ø³Ø§Ù… ÙØªØ­ÙŠ Ø§Ù„Ù„ÙˆØ²', '97470882208'),
    ('LTO2024177', '5888', 'atef sghairi', '97477024940'),
    ('AGR-202504-404457', '2775', 'Ø£Ù†ÙˆØ± Ø¬Ù†Ø¨ÙŠÙ†ÙŠ', '97451476442'),
