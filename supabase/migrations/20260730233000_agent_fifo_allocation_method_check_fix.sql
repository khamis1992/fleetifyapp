-- Fix allocation_method literals to satisfy payment_allocations_allocation_method_check
-- (allowed values: auto, manual, proportional, fifo).
-- Reapplies both functions with corrected literals (auto_fifo->fifo, merge_reallocation->manual).
