-- إزالة الإصدار المكرر من create_contract_journal_entry_enhanced
DROP FUNCTION IF EXISTS public.create_contract_journal_entry_enhanced(uuid, uuid) CASCADE;

-- إضافة دالة فحص وجود العقد المستخدمة في Edge Function
...
-- إضافة دالة مساعدة لمراقبة صحة العقود (مفقودة من النظام)
