-- إصلاح: المركبة يجب أن تبقى مؤجرة عند تحويل العقد للشؤون القانونية
-- المشكلة: عند تحويل العقد للشؤون القانونية، النظام كان يغير حالة المركبة إلى متاحة
-- الحل: تعديل الـ trigger ليتعامل مع حالة under_legal_procedure بشكل صحيح

-- تعديل دالة update_vehicle_status_from_contract لإضافة معالجة under_legal_procedure
...
'تحديث حالة المركبة تلقائياً عند تغيير حالة العقد.
