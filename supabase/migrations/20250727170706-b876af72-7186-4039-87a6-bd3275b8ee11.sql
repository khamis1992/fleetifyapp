-- Add missing vehicle fields to the vehicles table
...
ADD COLUMN IF NOT EXISTS useful_life_years INTEGER DEFAULT 10,
ADD COLUMN IF NOT EXISTS residual_value NUMERIC,
ADD COLUMN IF NOT EXISTS depreciation_method TEXT DEFAULT 'straight_line',
ADD COLUMN IF NOT EXISTS annual_depreciation_rate NUMERIC,
...
-- Create enhanced odometer_readings table
