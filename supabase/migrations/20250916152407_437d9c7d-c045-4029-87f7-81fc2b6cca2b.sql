-- Drop and recreate copy_default_cost_centers_to_company function with proper return type
DROP FUNCTION IF EXISTS public.copy_default_cost_centers_to_company(uuid);
