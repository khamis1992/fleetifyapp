...
CREATE TABLE IF NOT EXISTS public.safe_auto_repairs (
...
CREATE INDEX IF NOT EXISTS safe_auto_repairs_lookup_idx
...
DROP POLICY IF EXISTS "Company members read safe auto repairs"
...
DROP POLICY IF EXISTS "Company members upload MOI inbox files"
ON storage.objects;
...
DROP POLICY IF EXISTS "Company members read their MOI inbox files"
ON storage.objects;
