-- Reactivating the unchanged contract after all of its legal cases become
-- terminal is a legal-workflow reversal, not a new rental. Eligibility checks
-- remain mandatory for inserts, changed vehicle/customer assignments, and any
-- contract that still has an active legal case.
