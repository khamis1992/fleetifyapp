-- Create the corrected log_contract_creation_step function with proper parameter defaults
...
BEGIN
    ...
    IF company_id_param IS NULL OR step_name IS NULL OR status_param IS NULL THEN
        RETURN;
    END IF;
