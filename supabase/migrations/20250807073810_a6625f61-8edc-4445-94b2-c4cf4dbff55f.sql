...
INSERT INTO public.profiles (user_id, first_name, last_name, email, company_id, is_active, created_at, updated_at)
SELECT DISTINCT 
    e.user_id,
    e.first_name,
    e.last_name,
...
INSERT INTO public.user_roles (user_id, company_id, role, granted_at)
SELECT DISTINCT 
    p.user_id,
    p.company_id,
    'employee'::user_role,
