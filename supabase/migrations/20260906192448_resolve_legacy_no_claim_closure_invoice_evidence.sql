...
CREATE OR REPLACE FUNCTION contract_finance_private.close_no_claim_closure(
...
CREATE POLICY no_claim_closures_no_direct_access ON contract_finance_private.no_claim_closures
