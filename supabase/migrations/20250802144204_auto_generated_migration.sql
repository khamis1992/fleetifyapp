-- Update cleanup_orphaned_contract_logs function to use correct column names
...
-- Update create_contract_safe function to use correct column names
...
-- Update log_contract_creation_step function to use correct column names
