...
DROP FUNCTION IF EXISTS public.recalculate_account_levels(uuid);
DROP FUNCTION IF EXISTS public.fix_chart_hierarchy(uuid);
DROP FUNCTION IF EXISTS public.comprehensive_hierarchy_check(uuid);

-- إنشاء دالة إعادة حساب مستويات الحسابات المحسنة
...
-- إنشاء دالة إصلاح هرمية الحسابات المحسنة
...
-- إنشاء دالة للفحص الشامل للهرمية
