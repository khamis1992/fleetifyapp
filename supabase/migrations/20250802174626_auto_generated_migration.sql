-- Step 5: Create performance optimization indexes (without CONCURRENTLY)
CREATE INDEX IF NOT EXISTS idx_user_roles_user_id_role 
ON public.user_roles (user_id, role);

CREATE INDEX IF NOT EXISTS idx_profiles_user_id_company_id 
ON public.profiles (user_id, company_id);

CREATE INDEX IF NOT EXISTS idx_employees_user_id_company_id 
...
SELECT 'User ID ambiguity fix script completed successfully - Core functions and indexes created' as completion_status;