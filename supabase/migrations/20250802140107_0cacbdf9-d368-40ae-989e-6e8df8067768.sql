...
BEGIN
    ...
    IF contract_data->>'vehicle_id' IS NOT NULL AND contract_data->>'vehicle_id' != '' AND contract_data->>'vehicle_id' != 'none' THEN
        ...
        -- التحقق من الصيانة النشطة للمركبة - Fixed to use completed_date instead of expected_completion_date
        ...
        AND (
            ...
            OR completed_date BETWEEN (contract_data->>'start_date')::date AND (contract_data->>'end_date')::date
        );
