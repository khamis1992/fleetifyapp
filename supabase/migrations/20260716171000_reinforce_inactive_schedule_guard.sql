-- Reassert the schedule guard before adding the unique active-date constraint.
-- This is intentionally idempotent because some environments received the
-- earlier function definition outside the migration history.
