-- Create sample data with correct payment methods (fixing constraint violation)
...
BEGIN
    ...
    -- Create sample payments with correct payment methods
    IF sample_bank_account_id IS NOT NULL AND sample_customer_id IS NOT NULL THEN
        FOR i IN 1..8 LOOP
            INSERT INTO payments (
                ...
                CASE WHEN i % 3 = 0 THEN 'cash' WHEN i % 3 = 1 THEN 'transfer' ELSE 'cheque' END,
                800 + (i * 80),
                sample_customer_id,
