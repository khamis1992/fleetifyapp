-- Fix the validate_contract_realtime function to use correct field names and improve validation logic
    ...
    IF vehicle_id IS NOT NULL AND vehicle_id != '00000000-0000-0000-0000-000000000000'::uuid THEN
        ...
        IF FOUND THEN
            ...
            IF start_date IS NOT NULL AND end_date IS NOT NULL THEN
                ...
                AND (
                    (scheduled_date BETWEEN start_date AND end_date) OR
                    (completion_date BETWEEN start_date AND end_date) OR
                    (scheduled_date <= start_date AND (completion_date IS NULL OR completion_date >= end_date))
                );
            ...
            -- التحقق من تضارب المواعيد مع عقود أخرى
            IF start_date IS NOT NULL AND end_date IS NOT NULL THEN
