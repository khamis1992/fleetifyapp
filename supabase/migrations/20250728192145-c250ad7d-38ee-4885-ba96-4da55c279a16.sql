-- إنشاء بيانات اختبار للتنبيهات (نسخة مصححة)
...
BEGIN
    ...
    IF company_uuid IS NOT NULL THEN
        ...
        (gen_random_uuid(), company_uuid, 'A-123-45', 'تويوتا', 'كامري', 2020, 'active', 15000, CURRENT_DATE + INTERVAL '15 days', CURRENT_DATE + INTERVAL '10 days', now(), now()),
        (gen_random_uuid(), company_uuid, 'B-678-90', 'نيسان', 'التيما', 2019, 'active', 18000, CURRENT_DATE + INTERVAL '5 days', CURRENT_DATE + INTERVAL '30 days', now(), now()),
