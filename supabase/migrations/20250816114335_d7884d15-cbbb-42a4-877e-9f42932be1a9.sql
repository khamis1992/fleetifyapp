-- Add unique constraints to prevent duplicate customers
...
CREATE UNIQUE INDEX CONCURRENTLY idx_customers_company_national_id_unique 
...
CREATE UNIQUE INDEX CONCURRENTLY idx_customers_company_passport_unique 
