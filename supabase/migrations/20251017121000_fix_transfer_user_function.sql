-- Fix the transfer_user_to_company function to handle ENUM types correctly
...
-- Add comment
COMMENT ON FUNCTION transfer_user_to_company IS 'Transfers a user from one company to another with new roles (Fixed ENUM handling)';
