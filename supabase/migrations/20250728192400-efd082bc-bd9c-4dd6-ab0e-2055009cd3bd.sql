-- إنشاء بيانات اختبار للتنبيهات (نسخة مصححة مع قيم صحيحة)
...
BEGIN
    ...
    IF company_uuid IS NOT NULL THEN
        -- إضافة مركبات تجريبية بقيم صحيحة للـ status
        ...
        (gen_random_uuid(), company_uuid, 'C-111-22', 'هوندا', 'أكورد', 2021, 'in_maintenance', 20000, CURRENT_DATE + INTERVAL '60 days', CURRENT_DATE + INTERVAL '45 days', now(), now())
