-- Fix the create_customer_financial_account function with proper table aliases
...
-- Remove any old/duplicate versions of the function
DROP FUNCTION IF EXISTS public.create_customer_financial_account_fixed(uuid, uuid);
