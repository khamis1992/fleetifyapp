-- Create landing page management tables
...
-- Insert default landing theme
INSERT INTO public.landing_themes (company_id, theme_name, theme_name_ar, colors, fonts, spacing, is_default)
VALUES (
    '00000000-0000-0000-0000-000000000000', -- Global default
    'Default Theme',
    'الثيم الافتراضي',
    '{
        "primary": "220 90% 56%",
...
-- Insert default landing sections
INSERT INTO public.landing_sections (company_id, section_type, section_name, section_name_ar, sort_order, settings)
VALUES 
    ('00000000-0000-0000-0000-000000000000', 'hero', 'Hero Section', 'قسم البطل', 1, '{"layout": "centered", "background": "gradient"}'),
    ('00000000-0000-0000-0000-000000000000', 'features', 'Features Section', 'قسم الميزات', 2, '{"columns": 3, "layout": "grid"}'),
    ('00000000-0000-0000-0000-000000000000', 'testimonials', 'Testimonials Section', 'قسم الشهادات', 3, '{"layout": "carousel", "autoplay": true}'),
    ('00000000-0000-0000-0000-000000000000', 'cta', 'Call to Action', 'دعوة للعمل', 4, '{"style": "prominent", "position": "center"}')