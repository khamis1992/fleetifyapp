...
CREATE UNIQUE INDEX IF NOT EXISTS customer_merge_proposals_open_pair_idx
  ON public.customer_merge_proposals (company_id, primary_customer_id, duplicate_customer_id)
  WHERE status = 'pending';

CREATE INDEX IF NOT EXISTS customer_merge_proposals_company_idx
...
DROP POLICY IF EXISTS "Company members read merge proposals"
