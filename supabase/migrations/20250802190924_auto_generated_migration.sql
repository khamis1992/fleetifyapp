-- Clean up conflicting create_contract_journal_entry functions
-- Drop the old versions to eliminate ambiguity
...
DROP FUNCTION IF EXISTS public.create_contract_journal_entry_safe(uuid, uuid);

-- Update the create_contract_safe function to call the enhanced version
CREATE OR REPLACE FUNCTION public.create_contract_safe(contract_data jsonb, user_id_param uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
