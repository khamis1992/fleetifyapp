...
> **تحديث أمني — 28 أغسطس 2026:** الجدولة الحية تُنشأ حصراً بواسطة الهجرة
> `20260828113000_agent_failure_containment_and_escalation` بهوية Vault مستقلة و`x-agent-id`
> لكل وكيل. لا تستخدم أمثلة الأسرار المشتركة أو GitHub Actions أدناه للتشغيل الجديد؛
> بقيت بقية الصفحة مرجعاً تاريخياً فقط إلى أن تُحذف بعد اكتمال ترحيل الإنتاج.
