...
> **متقاعد للتشغيل الدوري:** الهجرة
> `20260828113000_agent_failure_containment_and_escalation` تنشئ cron بهويات Vault منفصلة.
> لا تستخدم أمثلة الأسرار المشتركة في هذا الملف ولا تنشئ جدولة GitHub موازية؛ وجود
> جدولين قد يكرر الفواتير أو الرسائل. المحتوى التالي مرجع تاريخي فقط.
