export const normalizeCsvHeaders = (row: Record<string, any>, entityType?: 'customer' | 'vehicle' | 'contract' | 'payment' | 'chart_account'): Record<string, any> => {
  ...
  const map: Record<string, string> = {
    // Arabic headers - Enhanced for comprehensive data support
    'اسم العميل': 'customer_name',
    'العميل': 'customer_name',
    'رقم العميل': 'customer_identifier', // معالجة خاصة
    'معرف العميل': 'customer_identifier',
    'معرّف العميل': 'customer_identifier',
