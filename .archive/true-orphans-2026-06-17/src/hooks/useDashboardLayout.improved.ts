...
const TABLET_LAYOUT: DashboardWidget[] = [
  { id: 'stats-vehicles', title: 'إجمالي المركبات', x: 0, y: 0, w: 5, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'stats-contracts', title: 'العقود النشطة', x: 5, y: 0, w: 5, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'stats-customers', title: 'إجمالي العملاء', x: 0, y: 2, w: 5, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'stats-revenue', title: 'إيرادات الشهر', x: 5, y: 2, w: 5, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'chart-revenue', title: 'الأداء المالي', x: 0, y: 4, w: 6, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'chart-fleet', title: 'حالة الأسطول', x: 6, y: 4, w: 4, h: 4, minW: 2, minH: 3, visible: true },
  { id: 'maintenance', title: 'جدول الصيانة', x: 0, y: 8, w: 5, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'calendar', title: 'تقويم الحجوزات', x: 5, y: 8, w: 5, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'forecast', title: 'توقعات الإيرادات', x: 0, y: 12, w: 5, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'activities', title: 'النشاطات الأخيرة', x: 5, y: 12, w: 5, h: 4, minW: 3, minH: 3, visible: true },
];

// التخطيط للهواتف الذكية (6 أعمدة)
const MOBILE_LAYOUT: DashboardWidget[] = [
  { id: 'stats-vehicles', title: 'إجمالي المركبات', x: 0, y: 0, w: 6, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'stats-contracts', title: 'العقود النشطة', x: 0, y: 2, w: 6, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'stats-customers', title: 'إجمالي العملاء', x: 0, y: 4, w: 6, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'stats-revenue', title: 'إيرادات الشهر', x: 0, y: 6, w: 6, h: 2, minW: 2, minH: 2, visible: true },
  { id: 'chart-revenue', title: 'الأداء المالي', x: 0, y: 8, w: 6, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'chart-fleet', title: 'حالة الأسطول', x: 0, y: 12, w: 6, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'maintenance', title: 'جدول الصيانة', x: 0, y: 16, w: 6, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'calendar', title: 'تقويم الحجوزات', x: 0, y: 20, w: 6, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'forecast', title: 'توقعات الإيرادات', x: 0, y: 24, w: 6, h: 4, minW: 3, minH: 3, visible: true },
  { id: 'activities', title: 'النشاطات الأخيرة', x: 0, y: 28, w: 6, h: 4, minW: 3, minH: 3, visible: true },
];
